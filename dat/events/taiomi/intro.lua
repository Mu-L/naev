...
function land ()
   ...
   if evt_state == 2 then
      ...
      vn.transition()
      vn.na(_("You dock with the one-winged Goddard and, once again, get out in your atmospheric suit. Once you exit the narrow hallways and enter the command room, you are once again met with the Drone which is a lot more intimidating in person."))
...
The voice sounds uncanny, almost human but something sets it apart.]]))
   ...
   d(_([["Please dock once more with the Goddard and I will explain the situation in slightly more detail."]]))
