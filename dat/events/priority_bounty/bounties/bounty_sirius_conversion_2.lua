...
return {
   ...
   spawnfunc      = function( b, params )
      ...
      m.comm_greet = saying
      local enemies = {p}
      for k,s in ipairs(bhelp.choose_ships_from_points_and_capship( p:ship(), bhelp.ships.pirate, 30 )) do
   ...
   cond = bhelp.cond_bounty_points( 20 ), --does not require conversion_1, either can be done in any order. Both will need to be complete for conversion_3
}
