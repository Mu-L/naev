...
return {
   ...
   msg_subdue     = { _("The ship is pitch-black inside. Disabled maintenance dones, spider-like with spindly limbs, lie collapsed in heaps or on their backs like dead bugs. You cross a catwalk over silent machinery, and enter the bridge. In the center of the room is a large spherical device, with connectors and exhaust tubes stretching haphazardly from it into ports on the walls, ceiling, and various conventional computer systems. It clicks and whirrs at your approach, several lights flashing with unknown meaning. A camera on the ceiling swivels to track your movements. As your crew rips out the cables, the lights die one by one, until the AI core lies dark and silent."), },
