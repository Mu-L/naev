...
function accept()
   ...
   m(_([["Let's just say that my espionage services are the best of the best, and leave it at that… shall we?"]])) -- When possible, the word "shall" should be italicized.
   vn.jump("mission description")
