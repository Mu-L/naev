...
Some types of effects can stack multiple times, which will be indicated by a number on the icon indicating how many stacks there are, while others will get refreshed when reapplied.
